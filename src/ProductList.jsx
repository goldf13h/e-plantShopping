...
function ProductList({ onHomeClick }) {
    ...
    cart ? cart.reduce((total, item) => total + (item.quantity || 0), 0) : 0;
    ...
    // Keep local addedToCart synced with the store (re-enable button if item removed)
    useEffect(() => {
        const map = {};
        cart.forEach(i => { map[i.name] = true; });
        setAddedToCart(map);
    }, [cart]);
                                ...
                                <div style={styleObjUl}>
                                        ...
                                        <div>
                                            <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                                                ...
                                                <span className="cart-count" style={{color:'white', marginLeft:8, fontSize:18}}>{cartCount}</span>
                                            </a>
                                        </div>
                                </div>
            </div>
